...
/// <summary>
/// An base agent that can be hosted in a runtime (<see cref="InProcessRuntime"/>).
/// </summary>
public abstract class RuntimeAgent : IHostableAgent
{
    ...
    {
        await this._runtime.PublishMessageAsync(message, topic, this.Id).ConfigureAwait(false); // %%% EXCEPTION: KeyNotFoundException/AggregateException
    }
}
